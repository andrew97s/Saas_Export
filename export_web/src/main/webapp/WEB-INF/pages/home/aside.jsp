                ...
                <c:if test="${module.CType==0}">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <c:forEach var="module2" items="${sessionScope.moduleList}">
                                <c:if test="${module.id==module2.parentId}">
                                    <li id="${module2.id}">
                                        <a href="${module2.CUrl}" onclick="setSidebarActive(this)"  target="iframe">
                                            <i class="fa fa-circle-o"></i>${module2.name}
                                        </a>
                                    </li>
                                </c:if>
                            </c:forEach>
